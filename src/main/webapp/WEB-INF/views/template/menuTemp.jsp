...
<%@ page import="com.springriders.perfume.utils.FileUtils" %>
<!DOCTYPE html>
<html>
<head>
...
<c:forEach items="${css}" var="item">
	<link rel="stylesheet" type="text/css" href="/css/${item}.css?ver=2">
</c:forEach>
</head>
<body>
	<div id="container">
						...
						<div id="profileImgContainer">
							<c:if test="${loginUser.profile_img == null}">
								<div id="profileImgBox">
									<img id="sidebarImg" class="profile" src="/img/default_img.jpg">					
								</div>
							</c:if>
							<!-- 프로필사진 등록시 -->
							<c:if test="${loginUser.profile_img != null}">
								<div id="profileImgBox">
									<img id="sidebarImg" class="profile" src="/img/profileImg/${loginUser.profile_img}">	
								</div>
							</c:if>
						</div>
