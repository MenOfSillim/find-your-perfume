			...
			<div id="sectionProfile">
				<div id="containerImg">
					<c:if test="${loginUser.profile_img == null}">
						<div id="profileImg">
							<img class="profile" src="/img/default_img.jpg">
						</div>
					</c:if>
					<c:if test="${loginUser.profile_img != null}">
						<div id="profileImg">
							<img class="profile" src="/img/profileImg/${loginUser.profile_img}">
						</div>
					</c:if>
					<div class="btn">
				...
				<div id="containerInfo">
					...
					<div id="infoContents">
						<div id="nickNameBox">
							...
							<div>
								<p>
									생년월일<span>Date of Birth</span>
								</p>
								<p class="ml10" id="bd_data">${loginUser.bd}</p>
							</div>
							<div id="r_dt">
								<p>
									가입일자<span>Date of Join</span>
								</p>
						...
						<div>
							<div>
								<p>
									비밀번호 변경<span>Password</span>
								</p>
								<input class="longInput" type="password" name="user_pw">
							</div>
							<div>
								<p>
									비밀번호 확인<span>Password check</span>
								</p>
