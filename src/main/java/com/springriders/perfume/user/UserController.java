...
import com.springriders.perfume.constant.ViewRef;
...
public class UserController {
	...
	public String join(MultipartHttpServletRequest mReq, UserPARAM param, RedirectAttributes ra) throws IOException {
